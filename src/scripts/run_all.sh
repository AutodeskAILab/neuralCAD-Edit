...
# 2. IMPORTANT: First run the fusion_convert script in Autodesk Fusion to extract images, stp, smt files generated by the harness.
# commented out as this has been done for the existing runs in the database.
